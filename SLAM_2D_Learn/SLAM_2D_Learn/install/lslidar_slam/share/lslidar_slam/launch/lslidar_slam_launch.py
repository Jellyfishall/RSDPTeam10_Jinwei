...
def generate_launch_description():
    ...
    async_slam_toolbox = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([get_package_share_directory("lslidar_slam"),"/launch","/lslidar_slam_slam.py"]),
    )
    
    static_tf_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([get_package_share_directory("lslidar_slam"),"/launch","/lslidar_slam_tf.py"]),
    )
    
    # lslidar_node = IncludeLaunchDescription(
    #     PythonLaunchDescriptionSource([get_package_share_directory("lslidar_slam"), "/launch", "/lslidar_slam_laser.py"]),
    #  )
    
    lslidar_rviz_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([get_package_share_directory("lslidar_slam"), "/launch", "/lslidar_slam_rviz.py"]),
     )
